...
insert into Students (name, preferredTimesStart, preferredTimesEnd, gradYear, major, openToNightClasses) values('John Doe', '8:00:00', '13:30:00', 2023, 'Math', false);
insert into Students (name, preferredTimesStart, preferredTimesEnd, gradYear, major, openToNightClasses) values('Kelly King', '12:30:00', '17:00:00', 2022, 'Computer Science', true);
insert into Students (name, preferredTimesStart, preferredTimesEnd, gradYear, major, openToNightClasses) values('Lola Lee', '13:00:00', '17:00:00', 2024, 'Undeclared', false);
insert into Students (name, preferredTimesStart, preferredTimesEnd, gradYear, major, openToNightClasses) values('Casey Carl', '8:00:00', '13:30:00', 2023, 'Math', true);
